...
## Introduction
<img width="1724" height="964" alt="image" src="https://github.com/user-attachments/assets/e5822dec-b4ba-4587-944b-c8249dedeb18" />
...
**Main Contributions:**
1. **mode test**를 통해 소수 속성(minority attributes)과 연관된 초기 노이즈들이 무작위로 산재하지 않고
   특정 **"minority regions"** 을 형성함을 발견하였다.
2. **mode test**를 통해 식별된 minority regions을 기반으로,
...
## Method
<img width="1722" height="966" alt="image" src="https://github.com/user-attachments/assets/d38b424b-0a2d-456a-a47b-f89895ff50ce" />
...
추가 학습 없이도 디바이어싱이 가능하다는 아이디어를 도출하였다.

---

### 2. Weak Guidance
<img width="1721" height="966" alt="image" src="https://github.com/user-attachments/assets/e96d7207-8a91-44cf-bd5f-d5147cc9faf1" />
...
- 이후 원래 프롬프트와 attribute direction을 적용한 프롬프트를 교대로 사용하여 guidance를 수행한다.
